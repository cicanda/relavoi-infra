...
variable "cors_origins" {
  type        = string
  description = "Allowed browser origins (Vercel dashboards / previews)."
  default     = "https://app.relavoi.com,https://admin.relavoi.com,https://*.vercel.app"
}
...
locals {
  ...
  # Non-secret runtime config passed straight into ECS task environments.
  app_env = {
    JWT_EXPIRY                            = "15m"
